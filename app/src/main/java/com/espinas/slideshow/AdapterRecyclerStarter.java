...
public class AdapterRecyclerStarter extends RecyclerView.Adapter<AdapterRecyclerStarter.ViewHolder> implements InfoTitle {
    ...
    public AdapterRecyclerStarter(Context context , List<ModelRecycler> modelRecyclers){

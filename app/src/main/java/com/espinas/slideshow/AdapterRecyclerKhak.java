...
public class AdapterRecyclerKhak extends RecyclerView.Adapter<AdapterRecyclerKhak.ViewHolder>{

   List<ModelRecycler> modelRecyclers;
   public AdapterRecyclerKhak(List<ModelRecycler> modelRecyclers){
